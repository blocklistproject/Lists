...
COMMON_TLDS = {
    ...
    "cn", "cr", "cu", "cv", "cw", "cx", "cy", "cz", "de", "dj",
    "dk", "dm", "do", "dz", "ec", "ee", "eg", "er", "es", "et", "eu",
    "fi", "fj", "fk", "fo", "fr", "ga", "gb", "gd", "ge", "gf",
    "gh", "gi", "gm", "gn", "gp", "gq", "gr", "gs", "gt",
    ...
    "rw", "sa", "sb", "sc", "sd", "se", "sg", "si", "sj", "sk",
    "sl", "sm", "sn", "so", "sr", "ss", "st", "su", "sv", "sx", "sy",
    "sz", "tc", "td", "tf", "tg", "th", "tj", "tk", "tl", "tm", "tn",
    "tr", "tt", "tw", "tz", "ua", "ug", "uk", "us", "uy",
    "uz", "va", "ve", "vg", "vi", "vn", "vu", "wf", "ye",
    "yt", "za", "zm", "zw",
}
...
def is_critical_domain(domain: str) -> bool:
    ...
    return any(domain_lower.endswith("." + critical) for critical in CRITICAL_DOMAINS)
