...
"""
# Generate 1000 unique domains, avoiding duplicates from existing file
# python domain_generator.py -k keyword1 keyword2 -c 1000 --existing current_blocklist.txt -o new_domains.txt

# Check memory usage during processing
# python domain_generator.py -f keywords.txt -c 5000 --existing huge_blocklist.txt --check-memory

# Work with different input formats
# python domain_generator.py -k adult content --existing pihole_blocklist.txt -c 200 --format pihole
