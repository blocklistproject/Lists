...
| PUP list | [Link](https://blocklistproject.github.io/Lists/pups.txt) | [Link](https://blocklistproject.github.io/Lists/alt-version/pups-nl.txt) | [Link](https://blocklistproject.github.io/Lists/dnsmasq-version/pups-dnsmasq.txt)| User requested list that blocks sites promoting or hosting [Unwanted Programs](https://en.wikipedia.org/wiki/Potentially_unwanted_program) (i.e. system cleaners which use intensional false positives) |  |
